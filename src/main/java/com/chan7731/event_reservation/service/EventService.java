package com.chan7731.event_reservation.service;

import com.chan7731.event_reservation.dto.EventDto;
import com.chan7731.event_reservation.model.Event;
import com.chan7731.event_reservation.repository.EventRepository;
...
public class EventService {
    ...
    public Page<Event> search(String name, String location, LocalDateTime from, LocalDateTime to, Pageable pageable) {
        ...
        if (name != null) specification = specification.and(
                (root, query, criteriaBuilder)
                        -> criteriaBuilder.like(root.get("name"), "%" + name + "%"));
        if (location != null) specification = specification.and(
                (root, query, criteriaBuilder)
